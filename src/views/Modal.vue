    ...
    <div class="modal__main">
      <div v-for="slopeOption in slopeOptions" :key="slopeOption">
        <div :class="radio_style(slopeOption.value)">
          <input type="radio" name="slope" :value="slopeOption.value" v-model="selected"/>
...
export default defineComponent({
  ...
  setup(props, context){
    ...
    const handleClickSubmit = () => {
      const selectedSlope = slopeOptions.find((opt) => opt.value === Number(selected.value))
      context.emit("updateSelectedSlope", selectedSlope)
    }
